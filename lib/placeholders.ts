 ...
 * нужно то же значение — guard-тест (tests/placeholders.test.ts) или чек-лист
 * первого экрана (components/dashboard/onboarding-panel.tsx) — берёт его
 * отсюда, а не набирает строку заново. Одно место правки вместо нескольких
 * синхронных копий.
 *

 ...
 * нужно то же значение — guard-тест (tests/placeholders.test.ts), стартовая
 * страница (app/page.tsx), настройка (setup.mjs) — берёт его отсюда, а не
 * набирает строку заново. Одно место правки вместо нескольких синхронных копий.
 *

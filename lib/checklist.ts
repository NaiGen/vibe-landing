...
/**
 * Чистая функция: текст брифа → чек-лист. Порядок групп и пунктов внутри
 * группы — как в брифе: список, за которым человек следит глазами,
 * не должен переставляться по мере заполнения.
 */
